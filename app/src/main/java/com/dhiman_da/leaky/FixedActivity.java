...
public class FixedActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (toolbar != null) {
            toolbar.setTitle(R.string.title_activity_fixed);
            setSupportActionBar(toolbar);
        }

        new ListGeneratorAsyncTask(this).execute();
    }
    ...
    public static class ListGeneratorAsyncTask extends AsyncTask<Void, Void, List<String>> {
        private WeakReference<FixedActivity> mWeakReference;

        public ListGeneratorAsyncTask(final FixedActivity activity) {
            mWeakReference = new WeakReference<FixedActivity>(activity);
        }
        ...
        protected void onPostExecute(List<String> list) {
            ...
            if (mWeakReference.get() != null) {
                mWeakReference.get().setupList(list);
            }
        }
    }
}
